                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDashboardDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ __('Dashboard') }} <span class="caret"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDashboardDropdown">
                                <a class="dropdown-item"
                                    href="{{ route('admin.user.index', app()->getLocale()) }}">{{ __('User') }}</a>
                            </div>
                        </li>
                        @endif
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                    href="{{ route('user.show', app()->getLocale()) }}">{{ __('Profile') }}</a>
